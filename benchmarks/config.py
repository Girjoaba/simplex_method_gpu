...
PROBLEMS = {
    ...
    # Additional problems discovered from measurements
    "sample": {
        "m": 2,
        "n": 4,
        "size": 8,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "sample",
    ...
    "sample3": {
        ...
        "n": 15,
        "size": 75,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "sample3",
        "expected_optimum": 4620.833333333334,
        "description": "Simple test problem",
    },
    "netlib_boeing1": {
        "m": 351,
        "n": 384,
        "size": 134784,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_boeing1",
        "expected_optimum": -335.2135675071266,
        "description": "NETLIB problem",
    },
    "netlib_boeing2": {
        "m": 167,
        "n": 143,
        "size": 23881,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_boeing2",
        "expected_optimum": -315.0187280152027,
        "description": "NETLIB problem",
    },
    "netlib_bore3d": {
        "m": 234,
        "n": 315,
        "size": 73710,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_bore3d",
        "expected_optimum": 1373.0803942084924,
        "description": "NETLIB problem",
    },
    "netlib_recipe": {
        "m": 92,
        "n": 180,
        "size": 16560,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_recipe",
        "expected_optimum": -266.616,
        "description": "NETLIB problem",
    },
    "netlib_finnis": {
        "m": 498,
        "n": 614,
        "size": 305772,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_finnis",
        "expected_optimum": 172791.06559561164,
        "description": "NETLIB problem",
    },
    "netlib_etamacro": {
        "m": 401,
        "n": 688,
        "size": 275888,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_etamacro",
        "expected_optimum": -755.7152329711329,
        "description": "NETLIB problem",
    },
    "netlib_pilot4": {
        "m": 411,
        "n": 1000,
        "size": 411000,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_pilot4",
        "expected_optimum": -2581.139261281172,
        "description": "NETLIB problem",
    },
    "netlib_seba": {
        "m": 516,
        "n": 1028,
        "size": 530448,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_seba",
        "expected_optimum": 15711.6,
        "description": "NETLIB problem",
    },
    "netlib_bnl1": {
        "m": 644,
        "n": 1175,
        "size": 756700,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_bnl1",
        "expected_optimum": 1977.6295615228862,
        "description": "NETLIB problem",
    },
    "netlib_maros": {
        "m": 847,
        "n": 1443,
        "size": 1222221,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_maros",
        "expected_optimum": -58063.74370112584,
        "description": "NETLIB problem",
    },
    "netlib_25fv47": {
        "m": 822,
        "n": 1571,
        "size": 1291362,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_25fv47",
        "expected_optimum": 5501.845888286747,
        "description": "NETLIB problem",
    },
    "netlib_modszk1": {
        "m": 688,
        "n": 1620,
        "size": 1114560,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_modszk1",
        "expected_optimum": 320.6197290648233,
        "description": "NETLIB problem",
    },
    "netlib_pilot.ja": {
        "m": 941,
        "n": 1988,
        "size": 1870708,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_pilot.ja",
        "expected_optimum": -6113.13646558138,
        "description": "NETLIB problem",
    },
    "netlib_pilotnov": {
        "m": 976,
        "n": 2172,
        "size": 2119872,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_pilotnov",
        "expected_optimum": -4497.276188218871,
        "description": "NETLIB problem",
    },
    "netlib_pilot.we": {
        "m": 723,
        "n": 2789,
        "size": 2016447,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_pilot.we",
        "expected_optimum": -2720107.532846229,
        "description": "NETLIB problem",
    },
    "netlib_d6cube": {
        "m": 416,
        "n": 6184,
        "size": 2572544,
        "file": os.path.join(PROJECT_ROOT, "benchmarks/input/") + "netlib_d6cube",
        "expected_optimum": -315.4916666666747,
        "description": "NETLIB problem - largest by dimension",
    },
}
...
SOLVERS = {
    ...
    "bm_v12": {
        "binary": os.path.join(PROJECT_ROOT, "bin_solver/bm_v12_fused.out"),
        "description": "bm fused kernels",
        "type": "parallel",
        "input_method": "stdin",
    },
    "bm_v13": {
        "binary": os.path.join(PROJECT_ROOT, "bin_solver/bm_v13_graph.out"),
        "description": "bm cuda graph",
        "type": "parallel",
        "input_method": "stdin",
    },
    "tp_v1": {
...
SUITES = {
    ...
    "all_12_6solvers": {
        "description": "16 problems - all 7 solvers (validated benchmark data)",
        "problems": [
            ...
            "netlib_grow22", "netlib_fit1p", "netlib_ship08s",
            # Medium 4 (removed ship04l to reduce x-axis crowding)
            "netlib_scsd8", "netlib_scfxm2", "netlib_standmps", "netlib_scrs8",
            # New large problems
            "netlib_bnl2", "netlib_maros-r7",
        ],
    ...
    "tp_v3_bm_v11_common": {
        "description": "67 problems with data for both tp_v3 and bm_v11",
        "problems": [
            "netlib_25fv47", "netlib_adlittle", "netlib_afiro", "netlib_agg", "netlib_agg2",
            "netlib_agg3", "netlib_bandm", "netlib_beaconfd", "netlib_blend", "netlib_bnl1",
            "netlib_bnl2", "netlib_boeing1", "netlib_boeing2", "netlib_bore3d", "netlib_brandy",
            "netlib_capri", "netlib_czprob", "netlib_e226", "netlib_etamacro", "netlib_fffff800",
            "netlib_finnis", "netlib_fit1d", "netlib_fit1p", "netlib_ganges", "netlib_gfrd-pnc",
            "netlib_grow15", "netlib_grow22", "netlib_grow7", "netlib_israel", "netlib_kb2",
            "netlib_lotfi", "netlib_maros", "netlib_maros-r7", "netlib_modszk1", "netlib_pilot4",
            "netlib_recipe", "netlib_sc105", "netlib_sc205", "netlib_sc50a", "netlib_sc50b",
            "netlib_scagr25", "netlib_scagr7", "netlib_scfxm1", "netlib_scfxm2", "netlib_scfxm3",
            "netlib_scorpion", "netlib_scrs8", "netlib_scsd1", "netlib_scsd6", "netlib_scsd8",
            "netlib_sctap1", "netlib_sctap2", "netlib_sctap3", "netlib_seba", "netlib_share1b",
            "netlib_share2b", "netlib_ship04l", "netlib_ship04s", "netlib_ship08s", "netlib_ship12s",
            "netlib_sierra", "netlib_stair", "netlib_standata", "netlib_standmps", "netlib_stocfor1",
            "netlib_stocfor2", "netlib_vtp.base",
        ],
        "solvers": ["tp_v3", "bm_v11"],
        "repetitions": 4,
        "warmup_iterations": 0,
        "warmup_problem": None,
        "hardware": "NVIDIA GeForce RTX 3060",
